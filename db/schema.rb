...
<<<<<<< HEAD
ActiveRecord::Schema.define(version: 20180424023928) do
=======
ActiveRecord::Schema.define(version: 20180424033110) do
>>>>>>> f3b5467... Teamモデルとseedデータ修正
  ...
  create_table "team_edit_rights", force: :cascade do |t|
    ...
    t.index ["user_id", "team_id"], name: "index_team_edit_rights_on_user_id_and_team_id", unique: true
